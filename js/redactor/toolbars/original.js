	  ...
	  dropdown:
		{
		  ...
		  h1: { exec: 'formatblock', name: '<h1>', title: RLANG.header1, style: '' },
		  h2: { exec: 'formatblock', name: '<h2>', title: RLANG.header2, style: '' }, h3: { exec: 'formatblock', name: '<h3>', title: 'Залоговок 3', style: '' }
	  ...
	  dropdown:
		{
		  ...
		  person: { func: 'personEdit', name: 'person', title: 'Карточка сотрудника' }
		}
	}
};